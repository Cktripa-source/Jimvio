...
export function HeroRightPanel({ profile }: HeroRightPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white border border-[#f0f0f0] rounded-xl p-6 shadow-sm">
        {isLoggedIn ? (
          <>
            <h4 className="text-[15px] font-black text-[#1a1a1a] mb-1 leading-tight">Welcome back</h4>
            ...
            <div className="flex items-center gap-3 mb-4 p-3 bg-[#fafafa] rounded-xl border border-[#f0f0f0]">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[13px] font-black text-[#1a1a1a] truncate">
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <Link
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 border border-[#f0f0f0] rounded-lg hover:bg-[#fff7ed] hover:border-[#f97316] transition-all font-bold text-[12px] text-[#1a1a1a]"
              >
          ...
          <>
            <h4 className="text-[15px] font-black text-[#1a1a1a] mb-1 leading-tight">Professional B2B Sourcing</h4>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <Link
          ...
          className="bg-white border border-[#f0f0f0] rounded-xl p-4 text-center group hover:border-[#f97316] hover:bg-[#fff7ed] transition-all shadow-sm"
        >
          <Factory className="h-6 w-6 text-[#f97316] mx-auto mb-2 transition-transform group-hover:scale-110" />
          <div className="text-[12px] font-black text-[#1a1a1a] mb-0.5">Supplier Store</div>
        ...
        >
          ...
          <div className="text-[12px] font-black text-[#1a1a1a] mb-0.5">Post Lead</div>
          <div className="text-[11px] text-[#f97316] font-black uppercase tracking-widest flex items-center justify-center gap-0.5">
      ...
      <Link
        href="/affiliates"
        className="bg-gradient-to-br from-[#1a1a1a] via-[#9a3412] to-[#f97316] rounded-xl p-5 flex items-center gap-4 group hover:brightness-110 transition-all shadow-lg overflow-hidden relative"
      >
