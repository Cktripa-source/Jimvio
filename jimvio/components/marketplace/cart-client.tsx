                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-zinc-900 group flex items-center gap-2 cursor-pointer">
                      ...
                      <ChevronRight className="h-4 w-4 text-zinc-300 group-hover:text-black transition-colors" />
                    </h3>
      ...
      <div className="lg:col-span-1">
        <div className="sticky top-40 space-y-6">
          <div className="bg-white rounded-[2rem] border border-[#eee] p-8 shadow-xl shadow-black/5">
            ...
            <Button size="lg" className="w-full bg-[#f97316] hover:bg-[#ea580c] text-white rounded-2xl h-16 text-sm font-black capitalize tracking-widest shadow-2xl shadow-orange-500/20 group">
          ...
          <div className="p-8 bg-zinc-900 rounded-[2rem] text-white">
            ...
            <div className="flex -space-x-3">
              {[1,2,3,4].map(i => (
                <div key={i} className="h-8 w-8 rounded-full border-2 border-zinc-900 bg-zinc-800 flex items-center justify-center overflow-hidden">
