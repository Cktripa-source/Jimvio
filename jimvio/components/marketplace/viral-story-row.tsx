    ...
    <>
          ...
          {showHeader && (
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[13px] font-black text-[#1a1a1a] tracking-widest capitalize">Live Viral Drops</h2>
              </div>
      ...
      {activeClipIndex !== null && (
        <div className="fixed inset-0 z-[1000] bg-black flex items-center justify-center animate-in fade-in duration-300">
          <div className="relative w-full max-w-[500px] bg-[#121212] overflow-hidden sm:rounded-3xl shadow-2xl flex flex-col h-screen sm:h-[90vh]">
            
            {/* Close Button */}
            <button 
              onClick={closePlayer}
              className="absolute top-6 right-6 z-[1100] w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-all"
            >
              <X className="h-6 w-6" />
            </button>
            ...
            <div className="flex-1 relative bg-black flex items-center justify-center overflow-hidden">
               ...
               <div className="w-full h-full flex flex-col items-center justify-center">
                  <div className="w-full h-full relative group">
                    ...
                    <div className="absolute inset-x-0 bottom-0 h-80 bg-gradient-to-t from-black/80 via-black/20 to-transparent z-10 pointer-events-none" />
                    ...
                    <button 
                      ...
                      className="absolute top-6 left-6 z-30 w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center text-white"
                    >
                    ...
                    <div className="absolute bottom-10 left-6 right-20 z-40 text-white">
                       ...
                       <div className="flex items-center gap-2 bg-black/30 backdrop-blur-md border border-white/10 rounded-full px-4 py-2 w-fit">
