  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "flex items-center gap-3 px-5 h-12 bg-white rounded-2xl border border-zinc-100 shadow-sm transition-all text-sm font-bold text-zinc-900 hover:border-black active:scale-95 whitespace-nowrap",
