  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a1a] via-[#2d1810] to-[#431407]" />
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-12 space-y-16">
        ...
        {/* ── CTA SECTION ── */}
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a1a1a] via-[#431407] to-[var(--color-accent)] p-12 md:p-16 text-white">
