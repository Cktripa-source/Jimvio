            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-[var(--shadow-sm)]">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {product.is_featured && (
                    <Badge className="bg-[#1a1a1a] text-white border-none">BEST SELLER</Badge>
                  )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                  ...
                  />
                  <Button size="lg" variant="outline" className="flex-1 font-bold rounded-xl h-14 border-2" asChild>
                    <Link href={`/dashboard/messages?vendor=${product.vendor_id}`}>
                ...
                <div className="p-8">
                  <TabsContent value="details" className="mt-0">
                    <div className="prose prose-sm max-w-none text-[var(--color-text-secondary)]">
                      <p className="text-lg leading-relaxed">{product.description || "No detailed description provided."}</p>
                    </div>
                  </TabsContent>
              ...
              <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-[var(--shadow-sm)]">
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  <div className="grid grid-cols-2 gap-2.5">
                    <Button className="w-full bg-[#1a1a1a] hover:bg-black font-black text-[12px] h-11 rounded-xl shadow-lg shadow-black/10" asChild>
                      <Link href="/messages">
