  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Global Stats card */}
        <Card className="bg-[#1a1a1a] text-white border-white/10 flex flex-col justify-center">
           <CardContent className="p-8 space-y-6">
              ...
              <Button className="w-full bg-white text-black hover:bg-white/90 font-black h-12">Upgrade My Tier</Button>
           </CardContent>
        </Card>
      </div>
